...
def print_most_common(hist, num=10):
    ...
    """
    pairs = most_common(hist, excluding_stopwords=False)
    for freq, word in pairs[0:num]:
        print(word, '\t', freq)
...
def subtract(d1, d2):
    ...
    for k in d1.items():
        if k not in d2.keys():
            d3.update([k]) # from stack overflow: https://stackoverflow.com/questions/68098040/take-dictionaries-d1-and-d2-and-returns-a-new-dictionary-that-contains-all-the-k
    return d3
